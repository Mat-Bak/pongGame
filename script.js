    ...
    let BALL_START_DX = 4.5;
    let BALL_START_DY = 1.5;
    ...
    const P1_UP_BUTTON = "ArrowUp";
    const P1_DOWN_BUTTON = "ArrowDown";
    const P2_UP_BUTTON = "KeyW";
    const P2_DOWN_BUTTON = "KeyS";
    ...
    class Ball {
        ...
        moveToStart() {
            ...
            let numX =  Math.floor(Math.random() * 2);
            let numY =  Math.floor(Math.random() * 2);
